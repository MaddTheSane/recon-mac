...
//
- (id)initWithTask:(NSTask *)aTask andObserver:(NSObject *)observer
{
   self = [super init];
   if (self != nil)
   {
   ...
   withObserver:(NSObject *)observer;
{
   ...
   TaskOutputReader *outputReader = [[TaskOutputReader alloc] initWithTask:task andObserver:observer];
